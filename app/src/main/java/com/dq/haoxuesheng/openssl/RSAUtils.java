package com.dq.haoxuesheng.openssl;
...
public final class RSAUtils {
    ...
    public static String PUCLIC_KEY = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDEroiJKwk3tRhhYsf4HC6mJ3Is\n" +
     ...
     * @return
     */
    public static byte[] decryptDataPublic(byte[] encryptedData, PublicKey publicKey) {
        try {
            Cipher cipher = Cipher.getInstance("RSA/ECB/PKCS1Padding");
